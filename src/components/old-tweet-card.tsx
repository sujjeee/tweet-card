...
export async function TweetCard({ tweetId }: { tweetId: string }) {
  ...
  return (
    <div className="relative flex h-fit w-full max-w-[32rem] flex-col gap-2 overflow-hidden rounded-lg border p-4 backdrop-blur-md mb-2  hover:scale-[1.01] transform transition duration-150 ">
